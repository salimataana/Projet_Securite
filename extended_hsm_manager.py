...
class ExtendedHSMManager(HSMManager):
    ...
    def __init__(self):
        ...
        self.performance_analyzer = PerformanceAnalyzer(self)  # AJOUTÉ
    ...
    def hash_and_sign(self, data, hash_algorithm='sha256', key_label=None):
        ...
        print(f"🔑 Clé demandée pour signature: {key_label}")  # DEBUG
        ...
        # Étape 2: Signature du hash (Chapitre 9) - CORRIGÉ : utiliser super()
        start_sign = time.time()
        signature = super().sign_data(data_hash, key_label)  # ← CORRECTION ICI
    ...
    def verify_hash_and_signature(self, data, signature, expected_hash, hash_algorithm='sha256', key_label=None):
        ...
        print(f"🔑 Clé demandée pour vérification: {key_label}")  # DEBUG
        ...
        # Étape 2: Vérifier la signature (Chapitre 9) - CORRIGÉ : utiliser super()
        is_valid = super().verify_signature(expected_hash, signature, key_label)  # ← CORRECTION ICI
    ...
    # AJOUT : Méthodes pour l'analyse de performance
    def get_performance_analysis(self):
        """Retourne l'analyse complète des performances"""
